    ...
    <div class="content-card">
        ...
        <div class="card-body">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
                <div class="checkbox-card selected" onclick="toggleCheckboxCard(this)">
                    <input type="checkbox" checked>
    ...
    <div class="content-card">
        ...
        <div class="card-body">
            <div style="display: grid; grid-template-columns: repeat(7, 1fr); gap: 8px;">
                <div class="checkbox-card selected" style="text-align: center; padding: 12px 8px;" onclick="toggleCheckboxCard(this)">
                    <input type="checkbox" checked>
                    <div class="checkmark-badge">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
                            <polyline points="20 6 9 17 4 12"></polyline>
                ...
                <div class="checkbox-card" style="text-align: center; padding: 12px 8px;" onclick="toggleCheckboxCard(this)">
                    <input type="checkbox">
...
@push('scripts')
<script>
// Toggle checkbox card with dynamic badge
function toggleCheckboxCard(card) {
    ...
    // Handle badge
    var badge = card.querySelector('.checkmark-badge');
    
    if (checkbox.checked) {
        // Show badge - create if doesn't exist
        if (!badge) {
            badge = document.createElement('div');
            badge.className = 'checkmark-badge';
            badge.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>';
            card.appendChild(badge);
        }
    } else {
        // Hide badge - remove from DOM
        if (badge) {
            badge.remove();
        }
    }
