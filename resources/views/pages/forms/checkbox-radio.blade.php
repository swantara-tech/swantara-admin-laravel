    ...
    <div class="content-card">
        ...
        <div class="card-body">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
                ...
                <div class="checkbox-card" onclick="this.classList.toggle('selected'); this.querySelector('input[type=checkbox]').checked = !this.querySelector('input[type=checkbox]').checked;">
    ...
    <div class="content-card">
        ...
        <div class="card-body">
            <div style="display: grid; grid-template-columns: repeat(7, 1fr); gap: 8px;">
                <div class="checkbox-card selected" style="text-align: center; padding: 12px 8px;" onclick="this.classList.toggle('selected'); this.querySelector('input[type=checkbox]').checked = !this.querySelector('input[type=checkbox]').checked;">
                ...
                <div class="checkbox-card" style="text-align: center; padding: 12px 8px;" onclick="this.classList.toggle('selected'); this.querySelector('input[type=checkbox]').checked = !this.querySelector('input[type=checkbox]').checked;">
                    <input type="checkbox" hidden>
