...
<div class="page-header">
    ...
    <div style="display: flex; gap: 10px;">
        ...
        <button class="btn btn-primary" onclick="MetroAdmin.copyDSGTAllColors()">
...
<div class="cl-colors-grid">
    <div class="dsgt-color-swatch">
        <div class="dsgt-color-swatch-preview" style="background: #0078D4;">
            <i class="fa-solid fa-droplet"></i>
        </div>
        <div class="dsgt-color-swatch-info">
            <h4 class="dsgt-color-swatch-name">Accent Primary</h4>
            <div class="dsgt-color-swatch-details">
                ...
                <div class="dsgt-color-swatch-detail">
                    ...
                    <span class="dsgt-color-contrast-badge high">AA ✓</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="dsgt-color-swatch">
        <div class="dsgt-color-swatch-preview" style="background: #16C60C;">
            <i class="fa-solid fa-check-circle"></i>
        </div>
        <div class="dsgt-color-swatch-info">
            <h4 class="dsgt-color-swatch-name">Success</h4>
            <div class="dsgt-color-swatch-details">
                <div class="dsgt-color-swatch-detail">
                    <span>HEX:</span>
                    <code>#16C60C</code>
    ...
    <div class="dsgt-color-swatch">
        <div class="dsgt-color-swatch-preview" style="background: #FFB900;">
            <i class="fa-solid fa-exclamation-triangle"></i>
        </div>
        <div class="dsgt-color-swatch-info">
            <h4 class="dsgt-color-swatch-name">Warning</h4>
            <div class="dsgt-color-swatch-details">
                <div class="dsgt-color-swatch-detail">
                    <span>HEX:</span>
                    <code>#FFB900</code>
                ...
                <div class="dsgt-color-swatch-detail">
                    ...
                    <span class="dsgt-color-contrast-badge medium">A ~</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="dsgt-color-swatch">
        <div class="dsgt-color-swatch-preview" style="background: #E81123;">
            <i class="fa-solid fa-times-circle"></i>
        </div>
        <div class="dsgt-color-swatch-info">
            <h4 class="dsgt-color-swatch-name">Danger</h4>
            <div class="dsgt-color-swatch-details">
                <div class="dsgt-color-swatch-detail">
                    <span>HEX:</span>
                    <code>#E81123</code>
    ...
    <div class="dsgt-color-swatch">
        <div class="dsgt-color-swatch-preview" style="background: #00BCF2;">
            <i class="fa-solid fa-info-circle"></i>
        </div>
        <div class="dsgt-color-swatch-info">
            <h4 class="dsgt-color-swatch-name">Info</h4>
            <div class="dsgt-color-swatch-details">
                <div class="dsgt-color-swatch-detail">
                    <span>HEX:</span>
                    <code>#00BCF2</code>
    ...
    <div class="dsgt-color-swatch">
        <div class="dsgt-color-swatch-preview" style="background: #808080;">
            <i class="fa-solid fa-circle"></i>
        </div>
        <div class="dsgt-color-swatch-info">
            <h4 class="dsgt-color-swatch-name">Secondary</h4>
            <div class="dsgt-color-swatch-details">
                <div class="dsgt-color-swatch-detail">
                    <span>HEX:</span>
                    <code>#808080</code>
    ...
    <div class="content-card">
        ...
        <div class="card-body">
            <div class="cl-example">
                ...
                <div class="dsgt-color-palette-grid">
                    <div class="dsgt-color-palette-item" style="background: #004578;" data-tooltip="#004578">900</div>
                    <div class="dsgt-color-palette-item" style="background: #005A9E;" data-tooltip="#005A9E">800</div>
                    <div class="dsgt-color-palette-item" style="background: #0068B3;" data-tooltip="#0068B3">700</div>
                    <div class="dsgt-color-palette-item" style="background: #0078D4;" data-tooltip="#0078D4">600</div>
                    <div class="dsgt-color-palette-item" style="background: #1A86D9;" data-tooltip="#1A86D9">500</div>
                    <div class="dsgt-color-palette-item" style="background: #3A96E0;" data-tooltip="#3A96E0">400</div>
                    <div class="dsgt-color-palette-item" style="background: #5AA6E6;" data-tooltip="#5AA6E6">300</div>
                    <div class="dsgt-color-palette-item" style="background: #7AB6ED;" data-tooltip="#7AB6ED">200</div>
                    <div class="dsgt-color-palette-item" style="background: #9AC6F3;" data-tooltip="#9AC6F3">100</div>
                    <div class="dsgt-color-palette-item" style="background: #BAD6FA;" data-tooltip="#BAD6FA">50</div>
                </div>
                <div class="cl-helper">
    ...
    <div class="content-card">
        ...
        <div class="card-body">
            <div class="cl-example">
                ...
                <div class="dsgt-color-palette-grid">
                    <div class="dsgt-color-palette-item" style="background: #0B8A08;" data-tooltip="#0B8A08">900</div>
                    <div class="dsgt-color-palette-item" style="background: #0FA80A;" data-tooltip="#0FA80A">800</div>
                    <div class="dsgt-color-palette-item" style="background: #12C60C;" data-tooltip="#12C60C">700</div>
                    <div class="dsgt-color-palette-item" style="background: #16C60C;" data-tooltip="#16C60C">600</div>
                    <div class="dsgt-color-palette-item" style="background: #2DD41A;" data-tooltip="#2DD41A">500</div>
                    <div class="dsgt-color-palette-item" style="background: #4CDD3A;" data-tooltip="#4CDD3A">400</div>
                    <div class="dsgt-color-palette-item" style="background: #6CE65A;" data-tooltip="#6CE65A">300</div>
                    <div class="dsgt-color-palette-item" style="background: #8CEE7A;" data-tooltip="#8CEE7A">200</div>
                    <div class="dsgt-color-palette-item" style="background: #ACF59A;" data-tooltip="#ACF59A">100</div>
                    <div class="dsgt-color-palette-item" style="background: #CCFDBA;" data-tooltip="#CCFDBA">50</div>
                </div>
                <div class="cl-helper">
                    <i class="fa-solid fa-circle-info"></i>
    ...
    <div class="content-card">
        ...
        <div class="card-body">
            <div class="cl-example">
                ...
                <div class="dsgt-color-gradient-box" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    Purple Dream
                </div>
                <div class="dsgt-color-gradient-info">
                    <span class="dsgt-color-gradient-name">Purple Dream</span>
                    <span class="dsgt-color-gradient-code">#667eea → #764ba2</span>
                </div>

                <div class="dsgt-color-gradient-box" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                    Pink Sunset
                </div>
                <div class="dsgt-color-gradient-info">
                    <span class="dsgt-color-gradient-name">Pink Sunset</span>
                    <span class="dsgt-color-gradient-code">#f093fb → #f5576c</span>
                </div>

                <div class="dsgt-color-gradient-box" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
                    Ocean Blue
                </div>
                <div class="dsgt-color-gradient-info">
                    <span class="dsgt-color-gradient-name">Ocean Blue</span>
                    <span class="dsgt-color-gradient-code">#4facfe → #00f2fe</span>
                </div>

                <div class="dsgt-color-gradient-box" style="background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%);">
                    Fresh Green
                </div>
                <div class="dsgt-color-gradient-info">
                    <span class="dsgt-color-gradient-name">Fresh Green</span>
                    <span class="dsgt-color-gradient-code">#43e97b → #38f9d7</span>
                </div>

                <div class="dsgt-color-gradient-box" style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%);">
                    Warm Flame
                </div>
                <div class="dsgt-color-gradient-info">
                    <span class="dsgt-color-gradient-name">Warm Flame</span>
                    <span class="dsgt-color-gradient-code">#fa709a → #fee140</span>
                </div>

                <div class="dsgt-color-gradient-box" style="background: linear-gradient(135deg, #ffecd2 0%, #fcb69f 100%);">
                    Peach Cream
                </div>
                <div class="dsgt-color-gradient-info">
                    <span class="dsgt-color-gradient-name">Peach Cream</span>
                    <span class="dsgt-color-gradient-code">#ffecd2 → #fcb69f</span>
                </div>
...
<div class="content-card">
    ...
    <div class="card-body">
        <div class="cl-example">
            ...
            <table class="dsgt-color-variables-table">
                <thead>
                    <tr>
                        <th>Variable</th>
                        <th>Value</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><span class="dsgt-color-preview" style="background: #0078D4;"></span>#0078D4</td>
                        <td>Primary actions, links, focus states</td>
                    </tr>
                    <tr>
                        <td><code>--success</code></td>
                        <td><span class="dsgt-color-preview" style="background: #16C60C;"></span>#16C60C</td>
                        <td>Success messages, confirmations</td>
                    </tr>
                    <tr>
                        <td><code>--warning</code></td>
                        <td><span class="dsgt-color-preview" style="background: #FFB900;"></span>#FFB900</td>
                        <td>Warning alerts, caution indicators</td>
                    </tr>
                    <tr>
                        <td><code>--danger</code></td>
                        <td><span class="dsgt-color-preview" style="background: #E81123;"></span>#E81123</td>
                        <td>Error messages, destructive actions</td>
                    </tr>
                    <tr>
                        <td><code>--info</code></td>
                        <td><span class="dsgt-color-preview" style="background: #00BCF2;"></span>#00BCF2</td>
                        <td>Informational messages, tips</td>
                    </tr>
                    <tr>
                        <td><code>--text-primary</code></td>
                        <td><span class="dsgt-color-preview" style="background: #1A1A1A;"></span>#1A1A1A</td>
                        <td>Main text content, headings</td>
                    </tr>
                    <tr>
                        <td><code>--text-secondary</code></td>
                        <td><span class="dsgt-color-preview" style="background: #808080;"></span>#808080</td>
                        <td>Secondary text, labels, captions</td>
                    </tr>
                    <tr>
                        <td><code>--bg-card</code></td>
                        <td><span class="dsgt-color-preview" style="background: #FFFFFF;"></span>#FFFFFF</td>
                        <td>Card backgrounds, containers</td>
                    </tr>
                    <tr>
                        <td><code>--bg-secondary</code></td>
                        <td><span class="dsgt-color-preview" style="background: #F8F9FA;"></span>#F8F9FA</td>
                        <td>Secondary backgrounds</td>
                    </tr>
                    <tr>
                        <td><code>--bg-tertiary</code></td>
                        <td><span class="dsgt-color-preview" style="background: #E9ECEF;"></span>#E9ECEF</td>
                        <td>Tertiary backgrounds, code blocks</td>
                    </tr>
                    <tr>
                        <td><code>--border-color</code></td>
                        <td><span class="dsgt-color-preview" style="background: #DEE2E6;"></span>#DEE2E6</td>
...
<div class="content-card">
    ...
    <div class="card-body">
        <div class="cl-example">
            ...
            <div class="dsgt-color-palette-grid">
                <div class="dsgt-color-palette-item" style="background: #030712; color: #fff;" data-tooltip="#030712">950</div>
                <div class="dsgt-color-palette-item" style="background: #111827; color: #fff;" data-tooltip="#111827">900</div>
                <div class="dsgt-color-palette-item" style="background: #1F2937; color: #fff;" data-tooltip="#1F2937">800</div>
                <div class="dsgt-color-palette-item" style="background: #374151; color: #fff;" data-tooltip="#374151">700</div>
                <div class="dsgt-color-palette-item" style="background: #4B5563; color: #fff;" data-tooltip="#4B5563">600</div>
                <div class="dsgt-color-palette-item" style="background: #6B7280; color: #fff;" data-tooltip="#6B7280">500</div>
                <div class="dsgt-color-palette-item" style="background: #9CA3AF;" data-tooltip="#9CA3AF">400</div>
                <div class="dsgt-color-palette-item" style="background: #D1D5DB;" data-tooltip="#D1D5DB">300</div>
                <div class="dsgt-color-palette-item" style="background: #E5E7EB;" data-tooltip="#E5E7EB">200</div>
                <div class="dsgt-color-palette-item" style="background: #F3F4F6;" data-tooltip="#F3F4F6">100</div>
                <div class="dsgt-color-palette-item" style="background: #F9FAFB;" data-tooltip="#F9FAFB">50</div>
            </div>
            <div class="cl-helper">
                <i class="fa-solid fa-circle-info"></i>
    ...
    <div class="content-card">
        ...
        <div class="card-body">
            <div class="cl-example">
                ...
                <div class="dsgt-color-palette-grid">
                    <div class="dsgt-color-palette-item" style="background: #083344; color: #fff;" data-tooltip="#083344">900</div>
                    <div class="dsgt-color-palette-item" style="background: #0E4B66; color: #fff;" data-tooltip="#0E4B66">800</div>
                    <div class="dsgt-color-palette-item" style="background: #156388; color: #fff;" data-tooltip="#156388">700</div>
                    <div class="dsgt-color-palette-item" style="background: #1C7FAA; color: #fff;" data-tooltip="#1C7FAA">600</div>
                    <div class="dsgt-color-palette-item" style="background: #239CCC; color: #fff;" data-tooltip="#239CCC">500</div>
                    <div class="dsgt-color-palette-item" style="background: #00BCF2; color: #fff;" data-tooltip="#00BCF2">400</div>
                    <div class="dsgt-color-palette-item" style="background: #33C8F5;" data-tooltip="#33C8F5">300</div>
                    <div class="dsgt-color-palette-item" style="background: #66D4F8;" data-tooltip="#66D4F8">200</div>
                    <div class="dsgt-color-palette-item" style="background: #99E0FA;" data-tooltip="#99E0FA">100</div>
                    <div class="dsgt-color-palette-item" style="background: #CCECFB;" data-tooltip="#CCECFB">50</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content-card">
        ...
        <div class="card-body">
            <div class="cl-example">
                ...
                <div class="dsgt-color-palette-grid">
                    <div class="dsgt-color-palette-item" style="background: #3B0764; color: #fff;" data-tooltip="#3B0764">900</div>
                    <div class="dsgt-color-palette-item" style="background: #581C87; color: #fff;" data-tooltip="#581C87">800</div>
                    <div class="dsgt-color-palette-item" style="background: #6B21A8; color: #fff;" data-tooltip="#6B21A8">700</div>
                    <div class="dsgt-color-palette-item" style="background: #7C3AED; color: #fff;" data-tooltip="#7C3AED">600</div>
                    <div class="dsgt-color-palette-item" style="background: #8B5CF6; color: #fff;" data-tooltip="#8B5CF6">500</div>
                    <div class="dsgt-color-palette-item" style="background: #A78BFA;" data-tooltip="#A78BFA">400</div>
                    <div class="dsgt-color-palette-item" style="background: #C4B5FD;" data-tooltip="#C4B5FD">300</div>
                    <div class="dsgt-color-palette-item" style="background: #DDD6FE;" data-tooltip="#DDD6FE">200</div>
                    <div class="dsgt-color-palette-item" style="background: #EDE9FE;" data-tooltip="#EDE9FE">100</div>
                    <div class="dsgt-color-palette-item" style="background: #F5F3FF;" data-tooltip="#F5F3FF">50</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="cl-example">
            ...
            <div style="display: flex; flex-direction: column; gap: 16px;">
                <div style="padding: 24px; background: var(--surface); border: 1px solid var(--border-color); border-radius: 8px;">
                    ...
                    <span class="dsgt-color-contrast-badge high" style="margin-left: 8px;">Primary BG</span>
                </div>
                ...
                <div style="padding: 24px; background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: 8px;">
                    ...
                    <span class="dsgt-color-contrast-badge high" style="margin-left: 8px;">Page BG</span>
                </div>
                ...
                <div style="padding: 24px; background: var(--bg-tertiary); border: 1px solid var(--border-color); border-radius: 8px;">
                    ...
                    <span class="dsgt-color-contrast-badge high" style="margin-left: 8px;">Code Blocks</span>
                </div>
                ...
                <div style="padding: 24px; background: var(--bg-overlay); color: var(--text-primary); border: 1px solid var(--border-color); border-radius: 8px;">
                    ...
                    <span class="dsgt-color-contrast-badge high" style="margin-left: 8px;">Modal BG</span>
                </div>
            </div>
            <div class="cl-helper">
                <i class="fa-solid fa-circle-info"></i>
        ...
        <div class="cl-example">
            ...
            <div style="display: flex; flex-direction: column; gap: 20px; padding: 20px; background: var(--surface); border-radius: 8px; border: 1px solid var(--border-color);">
                <div style="cursor: pointer;">
                    ...
                    <span class="dsgt-color-contrast-badge high">Highest Contrast</span>
                </div>
                ...
                <div style="cursor: pointer;">
                    ...
                    <span class="dsgt-color-contrast-badge high">Medium Contrast</span>
                </div>
                ...
                <div style="cursor: pointer;">
                    ...
                    <span class="dsgt-color-contrast-badge medium">Low Contrast</span>
                </div>
                ...
                <div style="cursor: pointer;">
                    ...
                    <span class="dsgt-color-contrast-badge high">Action Color</span>
                </div>
                ...
                <div style="cursor: pointer;">
                    ...
                    <span class="dsgt-color-contrast-badge high">Positive</span>
                </div>
                ...
                <div style="cursor: pointer;">
                    ...
                    <span class="dsgt-color-contrast-badge high">Critical</span>
                </div>
            </div>
            <div class="cl-helper">
                <i class="fa-solid fa-circle-info"></i>
            ...
            <table class="dsgt-color-variables-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><span class="dsgt-color-contrast-badge high">✓ Pass</span></td>
                    </tr>
                    <tr>
...
$(document).ready(function() {
    console.log('📋 DSGT Colors page loaded successfully');
});
</script>
@endpush